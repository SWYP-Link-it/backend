...
class ChatReadRepositoryTest {
    ...
    class SaveChatRead {
        ...
        void save() {
            ...
            ChatRead chatRead = ChatRead.create(chatRoom, mentor.getId(), lastReadMessageId);
            ...
            assertThat(savedChatRead.getId().getUserId()).isEqualTo(mentor.getId());
        ...
        void save_mentee() {
            ...
            ChatRead chatRead = ChatRead.create(chatRoom, mentee.getId(), lastReadMessageId);

            // when
            ChatRead savedChatRead = chatReadRepository.save(chatRead);

            // then
            assertThat(savedChatRead.getId().getUserId()).isEqualTo(mentee.getId());
            assertThat(savedChatRead.getLastReadMessageId()).isEqualTo(lastReadMessageId);
        }
    }
    ...
    class FindChatRead {
        ...
        void findById() {
            ...
            ChatReadId id = new ChatReadId(chatRoom.getId(), mentor.getId());
    ...
    class UpdateChatRead {
        ...
        void updateLastReadMessage() {
            ...
            ChatRead chatRead = ChatRead.create(chatRoom, mentor.getId(), initialMessageId);
            ChatRead savedChatRead = chatReadRepository.save(chatRead);
    ...
    class MultiUserChatRead {
        ...
        void independentReadInfo() {
            ...
            ChatRead mentorRead = ChatRead.create(chatRoom, mentor.getId(), mentorLastRead);
            ChatRead menteeRead = ChatRead.create(chatRoom, mentee.getId(), menteeLastRead);
