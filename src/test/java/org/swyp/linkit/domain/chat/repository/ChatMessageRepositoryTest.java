...
class ChatMessageRepositoryTest {
    ...
    class SaveMessage {
        ...
        void save() {
            // given
            ChatMessage message = ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "안녕하세요");
            ...
            assertThat(savedMessage.getSenderId()).isEqualTo(mentor.getId());
        ...
        void save_menteeMessage() {
            // given
            ChatMessage message = ChatMessage.create(chatRoom, mentee, SenderRole.MENTEE, "반갑습니다");

            // when
            ChatMessage savedMessage = chatMessageRepository.save(message);

            // then
            assertThat(savedMessage.getSenderId()).isEqualTo(mentee.getId());
    ...
    class FindMessages {
        ...
        void findByChatRoomIdOrderByCreatedAtAsc() {
            // given
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "첫 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentee, SenderRole.MENTEE, "두 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "세 번째 메시지"));
        ...
        void findTop50ByChatRoomIdOrderByIdDesc() {
            ...
            for (int i = 1; i <= 60; i++) {
                chatMessageRepository.save(
                        ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "메시지 " + i));
            }
        ...
        void findLastMessageByChatRoomId() {
            ...
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "첫 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentee, SenderRole.MENTEE, "두 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "마지막 메시지"));
    ...
    class CountMessages {
        ...
        void countByChatRoomIdAndIdGreaterThan() {
            ...
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentee, SenderRole.MENTEE, "두 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "세 번째 메시지"));
            chatMessageRepository.save(ChatMessage.create(chatRoom, mentee, SenderRole.MENTEE, "네 번째 메시지"));
        ...
        void countByChatRoomIdAndIdGreaterThan_noMessages() {
            ...
            ChatMessage lastMessage = chatMessageRepository.save(
                    ChatMessage.create(chatRoom, mentor, SenderRole.MENTOR, "마지막 메시지"));
