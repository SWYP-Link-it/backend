...
class ChatRoomDeleteRepositoryTest {
    ...
    void setUp() {
        ...
        User thirdUser = createAndSaveUser("third");
        User fourthUser = createAndSaveUser("fourth");
        chatRoom1 = chatRoomRepository.save(ChatRoom.create(mentor, mentee));
        chatRoom2 = chatRoomRepository.save(ChatRoom.create(mentor, thirdUser));
        chatRoom3 = chatRoomRepository.save(ChatRoom.create(mentor, fourthUser));
    }
    ...
    class SaveChatRoomDelete {
        ...
        void save() {
            // given
            ChatRoomDelete chatRoomDelete = ChatRoomDelete.create(chatRoom1, mentor.getId());
            ...
            assertThat(savedDelete.getCreatedAt()).isNotNull();
        }
        ...
        void save_mentee() {
            // given
            ChatRoomDelete chatRoomDelete = ChatRoomDelete.create(chatRoom1, mentee.getId());
    ...
    class FindChatRoomDelete {
        ...
        void findById() {
            ...
            ChatRoomDeleteId id = new ChatRoomDeleteId(chatRoom1.getId(), mentor.getId());
        ...
        void findDeletedRoomIdsByUserId() {
            // given
            chatRoomDeleteRepository.save(ChatRoomDelete.create(chatRoom1, mentor.getId()));
            chatRoomDeleteRepository.save(ChatRoomDelete.create(chatRoom2, mentor.getId()));
            // chatRoom3은 삭제하지 않음

            // when
            List<Long> deletedRoomIds = chatRoomDeleteRepository.findDeletedRoomIdsByUserId(mentor.getId());
    ...
    class ExistsChatRoomDelete {
        ...
        void existsById_ChatRoomIdAndId_UserId_otherUserDeleted() {
            // given
            chatRoomDeleteRepository.save(ChatRoomDelete.create(chatRoom1, mentee.getId()));
    ...
    class MultiUserDelete {
        ...
        void bothUsersCanDelete() {
            // given
            ChatRoomDelete mentorDelete = ChatRoomDelete.create(chatRoom1, mentor.getId());
            ChatRoomDelete menteeDelete = ChatRoomDelete.create(chatRoom1, mentee.getId());
