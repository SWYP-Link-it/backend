...
class ChatMessageDeleteTest {
    ...
    class CreateChatMessageDelete {
        ...
        void create() {
            ...
            ChatMessage chatMessage = ChatMessage.create(chatRoom, createMockUser(1L), SenderRole.MENTOR, "테스트 메시지");
            Long userId = 1L;
        ...
        void create_mentor() {
            ...
            Long mentorId = 1L;
            ChatRoom chatRoom = createDefaultChatRoom();
            ChatMessage chatMessage = ChatMessage.create(chatRoom, createMockUser(mentorId), SenderRole.MENTOR, "멘토 메시지");
        ...
        void create_mentee() {
            ...
            Long menteeId = 2L;
            ChatRoom chatRoom = createDefaultChatRoom();
            ChatMessage chatMessage = ChatMessage.create(chatRoom, createMockUser(menteeId), SenderRole.MENTEE, "멘티 메시지");
        ...
        void create_bothUsers() {
            ...
            Long menteeId = 2L;
            ChatRoom chatRoom = createDefaultChatRoom();
            ChatMessage chatMessage = ChatMessage.create(chatRoom, createMockUser(mentorId), SenderRole.MENTOR, "테스트 메시지");
        ...
        void create_multipleMessages() {
            ...
            Long userId = 1L;
            ChatRoom chatRoom = createDefaultChatRoom();
            ChatMessage message1 = ChatMessage.create(chatRoom, createMockUser(1L), SenderRole.MENTOR, "첫 번째 메시지");
            ChatMessage message2 = ChatMessage.create(chatRoom, createMockUser(2L), SenderRole.MENTEE, "두 번째 메시지");
            ChatMessage message3 = ChatMessage.create(chatRoom, createMockUser(1L), SenderRole.MENTOR, "세 번째 메시지");
