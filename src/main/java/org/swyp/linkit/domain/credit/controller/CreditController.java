...
public class CreditController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "크레딧 잔액 조회 성공", useReturnTypeSchema = true),
    ...
    public ResponseEntity<ApiResponseDto<CreditBalanceResponseDto>> getCreditBalance(
        ...
        return ResponseEntity.ok().body(ApiResponseDto.success("크레딧 잔액 조회 성공", responseDto));
    }

    // todo
//    @Operation(
//            summary = "사용자의 크레딧 잔액 및 유저 정보 조회",
//            description = "우저의 크레딧 잔액 및 프로필 이미지, 닉네임을 조회합니다."
//    )
//    // 크레딧 사용 내역에서 간단한 사용자 정보 + 크레딧
//    @GetMapping("/summary")
}
