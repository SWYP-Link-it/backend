...
public class NotificationController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "채팅방 미읽음 알림 개수 조회 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "요청 알림 읽음 처리 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "받은 요청 알림 읽음 처리 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "보낸 요청 알림 읽음 처리 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "메시지 알림 읽음 처리 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "채팅방 알림 읽음 처리 성공"),
            @ApiResponse(responseCode = "401", description = "인증이 필요합니다.")
    })
